...
export default function TermsPage() {
  return (
    <>
      <section className="section bg-[#0A0A0B] pt-[120px]" aria-labelledby="terms-heading">
        <div className="container max-w-[760px]">
          ...
          <h1 id="terms-heading" className="text-display-md font-light text-[#F5F5F0] mb-8">
            Terms of Use
          </h1>
          <div className="flex flex-col gap-6 text-[15px] text-[#B8B8B0] leading-[1.75]">
            <p>
              These terms of use apply to Qordova Labs Inc Pte. Ltd. and the Qordova.com website.
            </p>
            <p>
              By accessing this website, you agree that the content is provided for informational purposes only and does not constitute a commercial offer, binding agreement, or product warranty.
            </p>
            <p>
              Full terms of use will be published prior to any commercial product engagement. For questions, contact{' '}
              <a
